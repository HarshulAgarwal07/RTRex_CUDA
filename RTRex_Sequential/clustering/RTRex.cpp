...
int main(int argc, char *argv[])
{
  ...
  printf("mode = %c\n",mode); //modes available: s simple, e expand, p parallel clean + inner-loop
...
//   cg.print(fg);
  ...
  bool use_parallel_inner = (mode == 'p');
  decomposition = disjointExtract(&cg, eps, cluster_map, use_parallel_inner); // get the decomposition
